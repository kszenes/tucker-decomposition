...
SparseTensor3::SparseTensor3(const std::string &filename,
...
SparseTensor3::SparseTensor3(const std::vector<index_t> &other_sizes,
...
SparseTensor3::SparseTensor3(const SparseTensor3 &other, const std::vector<index_t>& permutation)
...
void SparseTensor3::sort_mode(const index_t mode) {
